...
(function(){
  ...
  function enhanceHome(){
    ...
    const html = `<div data-dynamic-hospital-block>${highlights + sections + newsHTML + videosHTML}</div>`;
  ...
  function renderNoticias(){
    ...
    mount.innerHTML = `
      ...
      <section class="section"><div class="container news-grid">${items.map(cardNews).join("") || "<p>Nenhuma notícia cadastrada.</p>"}</div></section>`;
  }
  ...
  function renderVideos(){
    ...
    mount.innerHTML = `
      ...
      <section class="section"><div class="container video-grid">${items.map(videoCard).join("") || "<p>Nenhum vídeo cadastrado.</p>"}</div></section>`;
  }
